...
![Stars](https://img.shields.io/github/stars/ssrjkk/hh-api-framework?style=social)
![Issues](https://img.shields.io/github/issues/ssrjkk/hh-api-framework)
![Forks](https://img.shields.io/github/forks/ssrjkk/hh-api-framework)
...
## Что это за проект
Фреймворк для проверки публичного API hh.ru:
- вакансии
- регионы
- справочники
...
- воспроизводимый запуск в CI и контейнерах
